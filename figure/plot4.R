...
png(file="C:/programming/r Course Lab 1/Plot4.png")
par(mfrow=c(2,2))
...
plot(x=household_pwr_feb1$DateTime,y=household_pwr_feb1$Voltage,type = "l",ylab="Voltage",xlab="Datetime")
...
plot(x=household_pwr_feb1$DateTime,y=household_pwr_feb1$Global_reactive_power,type = "l",ylab="Global_reactive_power",xlab="Datetime")
